...
//Create a ESP32 CAM SSID and PASSWORD//
const char* ssid = "ESP32CAM SSID"; 
const char* password = "ESP32CAM PASSWORD"; 
///////////////////////////////////////
...
void setup() {
  ...
  WiFi.softAPConfig(IPAddress(/* SET STATIC IP */ ), IPAddress(/* SET GATEWAY IP */), IPAddress(255, 255, 255, 0));   
